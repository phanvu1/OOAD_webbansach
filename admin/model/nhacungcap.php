...
function checkTrungTenVaEmailVaSdtNCC($tenNCC, $emailNCC, $sdtNCC) {
    ...
    // Kiểm tra tên
    $sqlTen = "SELECT COUNT(*) FROM nhacungcap WHERE tenncc = :tenNCC";
    ...
    // Kiểm tra email
    $sqlEmail = "SELECT COUNT(*) FROM nhacungcap WHERE email = :emailNCC";
    ...
    $sqlSDT = "SELECT COUNT(*) FROM nhacungcap WHERE sodienthoai = :sdtNCC";
...
function searchNCC($page, $limit, $keyword) {
    $offset = ($page - 1) * $limit;
    $conn = connectdb();
    $keyword = "%" . $keyword . "%";

    $countSql = "SELECT COUNT(*) FROM nhacungcap WHERE tenncc LIKE :keyword OR idnhacungcap LIKE :keyword 
    ...
    $sql = "SELECT * FROM nhacungcap WHERE tenncc LIKE :keyword OR idnhacungcap LIKE :keyword 
